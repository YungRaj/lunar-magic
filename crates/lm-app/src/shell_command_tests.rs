...
fn level_header_edit_requires_a_field_value_and_explicit_search_range() {
    ...
    assert_eq!(
        parse("level-header last-screen 1f 300000 400000").unwrap(),
        ShellCommand::EditLevelHeader {
            field: LevelHeaderField::LastScreen,
            value: 0x1f,
            search_start: 0x30_0000,
            search_end: 0x40_0000,
        }
    ...
    assert_eq!(
        parse("level-header time 2 300000 400000").unwrap(),
        ShellCommand::EditLevelHeader {
            field: LevelHeaderField::TimeLimitSelector,
            value: 2,
            search_start: 0x30_0000,
            search_end: 0x40_0000,
        }
