...
pub use vanilla_smw::{
    ...
    SMW_US_V1_SEPARATE_MIDWAY_HOOK_OFFSET, SMW_US_V1_SPECIAL_GRAPHICS_FILES,
    SMW_US_V1_SPECIAL_GRAPHICS_POINTER_OFFSET, SMW_US_V1_SPRITE_TILESET_GRAPHICS_OFFSET,
