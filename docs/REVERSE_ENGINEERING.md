...
the feature-control runtime is active. The table address is the mapped operand installed at runtime
...
separately, and performs checked checksum-repaired undoable writes.
