...
inheritance, full-checkpoint reset, and exact restoration. Reversion-link semantics and the
original automatic full-checkpoint cadence remain the next creation gaps.
