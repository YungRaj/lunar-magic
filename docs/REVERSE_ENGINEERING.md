...
history operation and requalifies identity on conversion, undo, redo, and save/reopen. Exact SA-1
6/8 MiB mapping and its ZSNES compatibility locks remain required before this workflow can be
promoted.
