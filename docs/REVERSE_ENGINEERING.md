...
rollover, otherwise delta; focused tests cover every branch and priority collision. Native controls
remain to connect these writer and policy APIs to an open document.
