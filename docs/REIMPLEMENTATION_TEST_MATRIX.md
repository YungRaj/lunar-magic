...
self-link, a two-node cycle, and out-of-range targets to remain typed failures. Compact
global/level ExAnimation remains provider-gated rather than being inferred from unrecovered transfer
kinds.
