...
`VanillaAnimation` option gates both eight-phase cache mutation and the 60 ms repaint clock; a
retained pristine-ROM test requires adjacent materialized phases to differ.
